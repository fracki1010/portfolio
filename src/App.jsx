...
function App() {
  ...
  return (
    <div className="min-h-screen p-4 md:p-8 lg:px-24 lg:py-16 selection:bg-indigo-500/30 relative">
      ...
      <div className="relative z-10">
        <motion.div 
          ...
          initial="hidden"
          animate="visible"
          className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-4 auto-rows-[100px] md:auto-rows-[120px]"
        >
          {/* --- ROW 1: HERO --- */}
          <motion.div 
            variants={itemVariants}
          ...
          >
            ...
            >
              ...
              <img
                src={profile}
                alt="profile"
                className="relative w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 rounded-full object-cover border-2 border-white/10"
              />
            </motion.div>
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-y-6 md:gap-y-10 gap-x-6 place-items-center grow py-4">
          ...
          {/* --- PROJECTS TITLE --- */}
          <AnimatedSection className="col-span-1 md:col-span-4 lg:col-span-6 mt-12 mb-2 px-2">
          ...
          {projects.map((project, idx) => (
            <AnimatedSection key={idx} delay={idx * 0.15} className="col-span-1 md:col-span-2 lg:col-span-3 row-span-3">
          ...
          {/* --- CONTACT CTA --- */}
          <AnimatedSection className="col-span-1 md:col-span-4 lg:col-span-6 row-span-2 mt-4">
            <div className="glass-card p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 bg-gradient-to-br from-indigo-500/10 to-transparent border-indigo-500/20">
              ...
              <a
                ...
                className="w-full md:w-auto group flex items-center gap-6 p-2 pr-6 bg-white/5 rounded-full hover:bg-white/10 transition-all border border-white/5 cursor-pointer hover:border-indigo-500/30"
              >
                ...
                <div className="flex flex-col text-left min-w-0">
                  ...
                  <span className="text-sm md:text-base text-white/80 font-mono truncate">franconicolasgaldame@gmail.com</span>
                </div>
